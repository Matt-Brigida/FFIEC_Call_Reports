...
This is a first look at the ffiec data.  In the app below you can get an idea for the data set.  Choose a quarter in the drop-down-box and identifying information on each bank in the sample *present in that quarter* is shown.  Below the table shows you the total number of entries in the table---that is the total number of banks in the data set that quarter. 

The search box will search over data present in all columns.  
