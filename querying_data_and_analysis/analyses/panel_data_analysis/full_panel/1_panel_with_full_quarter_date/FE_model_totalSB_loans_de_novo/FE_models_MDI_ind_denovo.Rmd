...
FEmodel2 <- plm(totSBloans_Delt ~  t1_RBCR_lagged_1_year + TETA_resid_RBCR + tot_lagged_SB_loans_TA + ROA + NPA_TA + I(log(panel2$total_assets_lagged_1_year)) + TD_TA + post_crisis_ind + fin_crisis_ind + I(t1_RBCR_lagged_1_year * black_ind) + I(t1_RBCR_lagged_1_year * hispanic_ind) + de_novo, data = panel2, model = "within", effect = "individual")
summary(FEmodel2)
```
