...
panel <- panel[c("quarter", "cost_of_funds", "total_assets_lagged_1_year", "ROA_lagged_1", "t1_LR_lagged_1_year", "t1_RBCR_lagged_1_year", "african_am_ind", "hispanic_ind", "asian_ind", "mdi_ind", "de_novo", "totSBloans_Delt", "tot_NPA_lagged_1", "tot_SB_loans_lagged_1_year", "TD_TA_lagged_1")]

panel$ln_total_assets <- log(panel$total_assets_lagged_1_year)
...
inputs <- panel[c("cost_of_funds", "ROA_lagged_1", "t1_RBCR_lagged_1_year", "de_novo", "tot_NPA_lagged_1", "tot_SB_loans_lagged_1_year", "TD_TA_lagged_1", "ln_total_assets")]

outputs <- panel[c("totSBloans_Delt")]
