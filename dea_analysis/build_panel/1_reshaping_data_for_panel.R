...
data <- readRDS("../../1_querying_data_and_analysis/analyses/panel_data_analysis/get_panel_data/pulling_all_firms/non_performing_loans/npa_30_89.rds")
...
data <- readRDS("../../1_querying_data_and_analysis/analyses/panel_data_analysis/get_panel_data/pulling_all_firms/non_performing_loans/npa_90_plus.rds")
