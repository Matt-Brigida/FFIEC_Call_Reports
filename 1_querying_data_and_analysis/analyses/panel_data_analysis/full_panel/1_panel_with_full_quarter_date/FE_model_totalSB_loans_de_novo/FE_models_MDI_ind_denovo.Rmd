...
data <- readRDS("../LHS_SB_data_code/panel_mdi_ind_denovo.rds")
...
FEmodel1 <- plm(totSBloans_Delt ~  t1_LR_lagged_1_year + TETA_resid_LR + tot_lagged_SB_loans_TA + ROA + NPA_TA + I(log(panel1$total_assets_lagged_1_year)) + I(log(panel1$total_assets_lagged_1_year) * ROA) + TD_TA + post_crisis_ind + fin_crisis_ind + I(t1_LR_lagged_1_year * black_ind) + I(t1_LR_lagged_1_year * hispanic_ind) + de_novo, data = panel1, model = "within", effect = "individual")
summary(FEmodel1)
```
...
panel2 <- panel[, c("quarter", "totSBloans_Delt", "t1_RBCR_lagged_1_year", "tot_lagged_SB_loans_TA", "ROA", "NPA_TA", "total_assets_lagged_1_year", "TD_TA", "post_crisis_ind", "black_ind", "hispanic_ind", "de_novo", "TETA")]
