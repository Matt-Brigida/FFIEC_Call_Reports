...
interval_size <- 500000  # this is $100 million
step_size <- 50000  # $20 million
...
while (start_upper + step_size * i < largest_bank){
    ...
    tryCatch({
        ...
        FEmodel1 <- plm(amt_CI_100_250_SB_loans_Delt ~  t1_LR_lagged_1_year + less_100_lagged_SB_loans_TA + ROA + NPA_TA + I(log(panel$total_assets_lagged_1_year)) + TD_TA + I(post_crisis_ind) + I(t1_LR_lagged_1_year * black_ind) + I(t1_LR_lagged_1_year * hispanic_ind), data = panel, model = "within", effect = "twoways")
